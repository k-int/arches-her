define(['knockout', 'proj4','underscore', 'viewmodels/widget', 'templates/views/components/widgets/bngpoint.htm'], function (ko, proj4, _, WidgetViewModel, bngpointWidgetTemplate) {
    /**
